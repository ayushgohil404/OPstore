...
import "./wishlist-U78bOMao.mjs";
import "./stripe-B0zodDBm.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/api-zWRieyl8.js
var login = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("c66295356ee1bed9dcd6acc6996417714105d1c255d6dc117cb348c4624a9cfa"));
var register = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("90c0569f8b22ccf890bd2d7f48cf7357d79e9dc19f53a36f84a9d9e02c742da3"));
...
var createReview = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("632bf91abf658b2254285f9bef0ccdfb006fbd68786b9dcc83d15846db6ef26c"));
var reviewsApi = {
...
var updatePassword = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("8ee5d321fad9ffed022ad5db7a3fd369840ab704fdd4d4cde7691b92cf2ebb3f"));
var settingsApi = {
