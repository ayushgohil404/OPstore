...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-CC7NuG2_.js
...
var register = createServerFn({ method: "POST" }).validator((data) => data).handler(register_createServerFn_handler, async ({ data }) => {
...
var getGoogleAuthUrl = createServerFn({ method: "GET" }).handler(getGoogleAuthUrl_createServerFn_handler, async () => {
	...
	return { url: `https://accounts.google.com/o/oauth2/v2/auth?client_id=${clientId}&redirect_uri=https://opstore.vercel.app/auth/google/callback&response_type=code&scope=email profile` };
});
