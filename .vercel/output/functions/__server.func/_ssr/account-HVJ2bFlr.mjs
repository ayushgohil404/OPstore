...
import { R as CircleCheck, h as ShieldCheck } from "../_libs/lucide-react.mjs";
import { a as settingsApi, t as authApi } from "./api-Cjn8KwVa.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/account-HVJ2bFlr.js
...
function AccountProfile() {
	...
	const handleSubmit = async (e) => {
		...
		if (firstName && email) await settingsApi.updateProfile({
			name: firstName,
			email
		});
	};
