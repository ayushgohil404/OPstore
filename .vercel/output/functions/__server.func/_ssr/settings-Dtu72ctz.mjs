...
//#region node_modules/.nitro/vite/services/ssr/assets/settings-Dtu72ctz.js
...
var updatePassword = createServerFn({ method: "POST" }).validator((data) => data).handler(updatePassword_createServerFn_handler, async ({ data }) => {
	const userId = getUserIdFromCookie();
	if (!userId) throw new Error("Unauthorized");
