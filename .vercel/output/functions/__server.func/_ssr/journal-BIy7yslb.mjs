...
import { B as Calendar, H as ArrowRight } from "../_libs/lucide-react.mjs";
import { n as createServerFn } from "./ssr.mjs";
import { t as createSsrRpc } from "./createSsrRpc-C1p7zOu_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/journal-BIy7yslb.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var subscribeNewsletter = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("e186aef83854d2461595c56ee64d3d818c971ea4f51906aee2b27faf50689a4b"));
var articles = [
	{
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								className: `text-sm text-left ${status.success ? "text-green-300" : "text-red-300"}`,
								children: status.message
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "submit",
							disabled: loading,
							className: "bg-white text-primary font-bold px-6 py-3 rounded-xl hover:bg-white/90 transition-colors disabled:opacity-70 h-[50px] sm:self-start",
