      ...
      <div className="hidden lg:flex w-1/2 relative bg-zinc-900">
        ...
        <div className="absolute bottom-12 left-12 z-20 max-w-md">
          ...
          <p className="text-lg text-zinc-300">
            Welcome back to your curated luxury experience. New arrivals are waiting for you.
          </p>
        </div>
      </div>

      {/* Right Form Panel */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 xl:p-24 bg-background border-l border-border">
